...
export default function UserMetaCard() {
  ...
  const { profile, setProfile, getProfile }: any = useProfile()
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <span className="py-3 px-5 bg-blue-700 text-white rounded-full">
            ...
            <div className={`py-3 px-6 rounded-lg ${() => {
              if (profile && profile.role == 'ADMIN') {
                return 'bg-purple-600 text-purple-800 font-bold'
              } else if (profile && profile.role == 'SUPERADMIN') {
                return 'bg-blue-600 text-blue-900 font-bold'
              } else {
                return 'bg-green-600 text-green-800 font-bold'
              }
            }
        ...
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            ...
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Actualiza información de tu perfil
            </p>
          </div>
